    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <Link href="/hr/candidates/new" className="btn-primary">
              ...
              <div key={candidate.id} className="card">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Link href={`/hr/candidates/${candidate.id}`} className="text-gray-400 hover:text-gray-600">
                      <Eye className="w-4 h-4" />
                    </Link>
                    <Link href={`/hr/candidates/${candidate.id}/edit`} className="text-gray-400 hover:text-blue-600">
                      ...
                      <div className="space-y-2">
                        {assignedTests.map((test) => (
                          <div key={test.id} className="flex items-center justify-between p-2 bg-gray-50 rounded">
                            ...
                            <Link 
                              href={`/hr/candidates/${candidate.id}/assign-test`}
                ...
                <div className="flex gap-2 mt-4 pt-4 border-t">
                  ...
                  <Link 
                    href={`/hr/candidates/${candidate.id}/submissions`}
                    className="flex-1 btn-outline text-sm"
                  >
